...
Mock.mock(config.baseUrl+"/captcha", 'post', () => {
...
Mock.mock(config.baseUrl+'/login', 'post', () => {
...
Mock.mock(config.baseUrl+'/sys/userInfo', 'get', () => {

	Result.data = {
		id:"001",
		username:"DavidNan",
		avatar:'@/assets/DavidNan.gif'
	}

	return Result
})

Mock.mock(config.baseUrl+'/logout', 'post', () => {
